...
var A = React.createClass({displayName: "A",
	render: function() {
		...
		return React.createElement("a", {href: '#' + href}, this.props.children)
	}
});
...
var PathBase = React.createClass({displayName: "PathBase",
	getUrl: function() {
...
var Path = React.createClass({displayName: "Path",
	...
	render: function() {
		return React.createElement(PathBase, {name: this.props.name, render: this.props.render, call: this.props.call, params: this.props.params, children: this.props.children, forward: true});
	}
});

var PathEnd = React.createClass({displayName: "PathEnd",
	propTypes: {
		name: React.PropTypes.string.isRequired
	},
	render: function() {
		return React.createElement(PathBase, {name: this.props.name, render: this.props.render, call: this.props.call, params: this.props.params, children: this.props.children, forward: false});
	}
});
